...
const SYSTEM_PROMPT = `You are a military training scenario engine for 2nd year cadets at a military university.
...
const OPENING_SCENARIO = `You are Lieutenant Hassan. You lead a team of 8 soldiers at a desert outpost.

Your mission: deliver medical supplies to Camp Falcon, 40km away across the desert. You must arrive before sunset — 6 hours from now.

Situation:
- 2 trucks are ready. Truck 2 has a small engine problem. It is slow but working.
- The main road is fast (2 hours) but there are reports of a road accident causing a closure ahead.
- The desert track is clear but long (4 hours) and very hot today (42 degrees).
- One of your soldiers, Private Saeed, says he feels sick. He can still walk.`;

const OPENING_CHOICES = [
  "Take the main road — faster, but the accident closure may delay you.",
